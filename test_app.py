...
class BloglyUserViewsTestCase(TestCase):
    ...
    def test_show_user(self):
        with app.test_client() as client:
            ...
            self.assertIn(f'<p>ID: {self.user_id}</p>', html)
    ...
    def test_add_user(self):
        with app.test_client() as client:
            ...
            resp = client.post("/user", data=new_user_info, follow_redirects=True)
            html = resp.get_data(as_text=True)

            self.assertIn('<h1>Jane Smith</h1>', html)
            self.assertIn('<p>ID: 2</p>', html)
    ...
    def test_delete_user(self):
        with app.test_client() as client:
            ...
            resp = client.post(f"/user/{self.user_id}", data=delete_action_call, follow_redirects=True)
            html = resp.get_data(as_text=True)
    ...
    def test_edit_user(self):
        with app.test_client() as client:
            ...
            resp = client.post(f'/user/{self.user_id}/edit', data=edit_data, follow_redirects=True)
            html = resp.get_data(as_text=True)

            self.assertNotIn('<h1>John Doe</h1>', html)
            self.assertIn('<h1>Walter White</h1>', html)
            self.assertIn(f'<p>ID: {self.user_id}', html)
